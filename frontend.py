...
def add_command():
    backend.insert(name_text.get(),address_text.get(),phone_number_text.get(),no_of_days_text.get(),room_type_text.get(),amount_text.get())
    list1.delete(0,END)
    list1.insert(END,(name_text.get(),address_text.get(),phone_number_text.get(),no_of_days_text.get(),room_type_text.get(),amount_text.get()))

def delete_command():
    backend.delete(selected_tuple[0])

def update_command():
    backend.update(selected_tuple[0],name_text.get(),address_text.get(),phone_number_text.get(),room_type_text.get(),no_of_days_text.get(),amount_text.get())
